...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--data_path",
        default=os.path.join(path, 'data/amazon_reviews_80.txt'),
        type=str,
        required=False,
    ...
    parser.add_argument("--fp16", default=False, type=bool, required=False, help="use float16")
    ...
    # create datasets
    train_set = AmazonDataset(pd_data, tokenizer, max_length, special_tokens)
